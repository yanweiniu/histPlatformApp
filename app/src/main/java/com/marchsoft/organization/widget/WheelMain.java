...
import com.marchsoft.organization.adapter.NumericWheelAdapter;
...
public class WheelMain {
	...
	private static int START_YEAR = 1970, END_YEAR = 2016;
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m) {
		...
		if (hasSelectTime) {
			...
			wv_hours.setLabel("time");
			wv_hours.setCurrentItem(h);

			wv_mins.setAdapter(new NumericWheelAdapter(0, 59));
			wv_mins.setCyclic(true);
			wv_mins.setLabel("fen");
