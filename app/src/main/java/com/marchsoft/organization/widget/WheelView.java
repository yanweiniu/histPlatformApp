...
import com.marchsoft.organization.adapter.WheelAdapter;
...
public class WheelView extends View {
	...
	private static final int ITEMS_TEXT_COLOR = 0xFF8F8F8F;
	...
	/*	*//*	float textWidth = FloatMath.ceil(Layout.getDesiredWidth("0",
		...
		boolean recalculate = false;/*	if (label != null && label.length() > 0) {
