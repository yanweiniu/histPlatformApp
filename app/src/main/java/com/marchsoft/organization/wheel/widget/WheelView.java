...
package com.marchsoft.organization.wheel.widget;
...
import com.marchsoft.organization.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	/**
	 * Scroll the wheel
	 * @param //itemsToSkip items to scrollsss
